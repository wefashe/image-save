...
public class Image implements Comparable<Image> {
     ...
     */
    private static String BING_API = "https://cn.bing.com/HPImageArchive.aspx?format=js&idx=%s&n=%s&nc=1612409408851&pid=hp&FORM=BEHPTB&uhd=1&uhdwidth=3840&uhdheight=2160&setlang=zh-cn&cc=cn";
    ...
    public String getTopMarkdownText() {
        String alt = getWith1000Alt();
        String img = getWith1000Url();
